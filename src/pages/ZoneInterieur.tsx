...
import { tablesInterieur, getZoneStats } from '../data/mockData';
  ...
  return (
    <div className="h-screen theme-bg-gradient p-10">
      ...
      <div className="flex justify-between items-center mb-8 h-20">
        <div>
          <h1 className="text-3xl font-bold theme-gradient-text mb-2">Intérieur</h1>
          <p className="theme-secondary-text">
            {stats.interieur.total} tables • {stats.interieur.occupees} occupées • {stats.interieur.libres} libres
          </p>
        </div>
        <button
