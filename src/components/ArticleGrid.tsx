      ...
      <div className="grid grid-cols-3 gap-0">
        {items.map((item) => (
          <button
            ...
            className={`
              theme-menu-card p-2 h-16 w-full flex flex-col items-center justify-center text-xs font-medium transition-all duration-300 relative border-0 rounded-none
